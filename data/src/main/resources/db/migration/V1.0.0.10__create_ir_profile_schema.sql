...
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `cert_photos` (
    `id`                    CHAR(36)        NOT NULL COMMENT 'UUID v4',
...
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `playing_habits` (
    `id`                    CHAR(36)        NOT NULL COMMENT 'UUID v4',
    `user_id`               CHAR(36)        NOT NULL COMMENT '关联用户ID',
...
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `habit_cities` (
    `id`                    CHAR(36)        NOT NULL COMMENT 'UUID v4',
...
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `habit_districts` (
    `id`                    CHAR(36)        NOT NULL COMMENT 'UUID v4',
    `habit_id`              CHAR(36)        NOT NULL COMMENT '关联playing_habits.id',
...
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `habit_courts` (
    `id`                    CHAR(36)        NOT NULL COMMENT 'UUID v4',
    `habit_id`              CHAR(36)        NOT NULL COMMENT '关联playing_habits.id',
...
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `habit_weekly_slots` (
    `id`                    CHAR(36)        NOT NULL COMMENT 'UUID v4',
    `habit_id`              CHAR(36)        NOT NULL COMMENT '关联playing_habits.id',
...
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `tennis_profile_idols` (
    `id`                    CHAR(36)        NOT NULL COMMENT 'UUID v4',
...
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `tennis_profile_serve_types` (
    `id`                    CHAR(36)        NOT NULL COMMENT 'UUID v4',
    `profile_id`            CHAR(36)        NOT NULL COMMENT '关联tennis_profiles.id',
...
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `tennis_profile_strength_tags` (
    `id`                    CHAR(36)        NOT NULL COMMENT 'UUID v4',
    `profile_id`            CHAR(36)        NOT NULL COMMENT '关联tennis_profiles.id',
...
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `tennis_profile_improvement_tags` (
    `id`                    CHAR(36)        NOT NULL COMMENT 'UUID v4',
    `profile_id`            CHAR(36)        NOT NULL COMMENT '关联tennis_profiles.id',
    `tag`                   VARCHAR(30)     NOT NULL COMMENT '标签名',
    `status`                TINYINT         NOT NULL DEFAULT 0 COMMENT '数据状态: 0=正常, -1=删除',
...
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `equipment_bags` (
    `id`                    CHAR(36)        NOT NULL COMMENT 'UUID v4',
    `user_id`               CHAR(36)        NOT NULL COMMENT '关联用户ID',
    `created_at`            TIMESTAMP       NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `updated_at`            TIMESTAMP       NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- 18. tennis_shoes - 球鞋
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `tennis_shoes` (
    `id`                    CHAR(36)        NOT NULL COMMENT 'UUID v4',
    `bag_id`                CHAR(36)        NOT NULL COMMENT '关联equipment_bags.id',
    `brand`                 VARCHAR(50)     NOT NULL COMMENT '品牌',
    `model`                 VARCHAR(100)    NOT NULL COMMENT '型号',
...
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `tennis_string_setups` (
    `id`                    CHAR(36)        NOT NULL COMMENT 'UUID v4',
...
CREATE TABLE IF NOT EXISTS `tennis_stars` (
    `id`                    CHAR(36)        NOT NULL COMMENT 'UUID v4',
